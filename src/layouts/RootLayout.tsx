          ...
          <div className="col-lg-2 col-md-2 col-xl-2 side-bar">
            <div className="d-flex flex-column pt-4">
              <ul className="nav flex-column mb-sm-auto mb-0" id="menu">
                ...
                <li className="nav-item">
                  <NavLink to="feedback" className="nav-link align-middle px-0">
                    <i className=" bi-house"></i>{" "}
                ...
                <li className="nav-item">
                  <NavLink to="settings" className="nav-link align-middle px-0">
                    <i className=" bi-house"></i>{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Account Settings
                    </span>
                ...
                <li>
                  <button
                    ...
                    style={{ background: "none", border: 0, color: "#000000", fontWeight: "800"}}
                  >
                    <i><LogoutCurve size="32" color="#000000" variant="Bold"/></i>{" "}
